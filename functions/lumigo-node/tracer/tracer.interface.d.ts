...
export type ResponseStreamHandler<TEvent = any, TResult = any> = (event: TEvent, responseStream: any, context: Context, callback?: Callback<TResult>) => void | Promise<TResult>;
