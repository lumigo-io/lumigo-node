...
export const createRedisSpan = (transactionId, awsRequestId, spanId, requestMetadata, redisFields) => {
    ...
    return Object.assign(Object.assign({}, baseSpan), { started: requestMetadata.started, requestCommand: command, requestArgs: args ? payloadStringify(args) : args, connectionOptions: redisFields.connectionOptions });
};
