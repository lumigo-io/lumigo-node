...
export const createNeo4jSpan = (transactionId, awsRequestId, spanId, requestMetadata, dbFields, spanType) => {
    const baseSpan = getBasicChildSpan(transactionId, awsRequestId, spanId, spanType);
    return Object.assign(Object.assign({}, baseSpan), { started: requestMetadata.started, connectionParameters: dbFields.connectionParameters, query: truncate(dbFields.query, getEventEntitySize()), params: dbFields.params ? payloadStringify(dbFields.params) : null });
};
