...
describe('tracer.unhandledRejections with original handler', () => {
  const spies = {};
  ...
  test('trace => UnhandledPromiseRejection with original handler', async () => {
    process.exit = jest.fn();
    process._events.unhandledRejection = process._events.unhandledRejection || jest.fn();
