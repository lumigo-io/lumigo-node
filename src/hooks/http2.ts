...
export class Http2 {
  ...
  static http2RequestArguments(args: any[]): { url?: string; options?: any; callback?: Function } {
    ...
    if (
      ...
      logger.debug('HTTP/2 request arguments: first arg is object', {
        ...
        isHttp2Headers: !!(headers[':method'] && headers[':path'] && (headers[':scheme'] || headers[':authority']))
      });
  ...
  // @GlobalDurationTimer.timedSync()
  // static http2BeforeConnectWrapper(args, extenderContext) {
  ...
  //     logger.debug('HTTP/2 adding headers to request', { addedHeaders, headers });
  ...
  static http2AfterConnectWrapper(args, originalFnResult, extenderContext) {
    ...
    extender.hook(clientHttp2Session, 'request', {
      beforeHook: (args) => {
        ...
        // logger.debug('HTTP/2 session request before hook', {
        //   headers,
        //   hasRequestData: !!requestData,
        //   hasRequestDataHeaders: requestData && !!requestData.headers,
        // });
        //
        ...
        //   args[0] = headers;
        //   logger.debug('HTTP/2 merged headers', { mergedHeaders: headers });
        // }
        //
        ...
        // logger.debug('HTTP/2 returning request data for after hook', {
        //   requestRandomId,
        ...
        //   hasCurrentSpan: !!currentSpan,
        // });
        // logger.debug('HTTP/2 session request before hook returning data', {
        //   requestRandomId,
        //   requestData,
        //   currentSpan,
        // });
  ...
  static wrapHttp2Lib(http2Lib) {
    ...
    extender.hook(http2Lib, 'connect', {
      // beforeHook: Http2.http2BeforeConnectWrapper,
    ...
    //   logger.info('HTTP/2 hooking createSecureClient method');
    //   console.log('HTTP/2 hooking createSecureClient method');
