...
const myHandler = async (event, context) => {
    ...
    try {
        ...
        // Simulate some business logic (manual tracing not available in custom tracer)
        console.log('🔄 Processing user data...');
        
        // Simulate user processing
        console.log('👤 Validating user data...');
        console.log('  - User ID:', eventData.user?.id || 'unknown');
        console.log('  - User Email:', eventData.user?.email || 'unknown');
        ...
        console.log('  - Input size:', JSON.stringify(eventData).length, 'characters');
        ...
        const result = {
            message: 'User processed successfully with anonymization',
            ...
            businessLogic: 'This Lambda demonstrates manual tracing with custom spans for business operations'
        };
