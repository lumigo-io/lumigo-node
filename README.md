...
* `LUMIGO_DOMAINS_SCRUBBER_SSM` - Path of a SSM Paramter. If this is set, the parameter is loaded at cold start and used as LUMIGO_DOMAINS_SCRUBBER. The Lambda must have permission to get that parameter from SSM.
